...
type Props = {
  ...
  options: any; // FIXME any
  selectedOption: any; // FIXME any
  handleOptionChange: any; // FIXME any
};
  ...
  return (
    <>
      <div className="flex w-full max-w-[155px] text-ellipsis min-[414px]:max-w-[250px]">
        <h6 className="ml-2.5 mr-[30px] flex-1 truncate font-banner text-[16px] leading-none text-mainBrown">
          {selectedOption.name}
        </h6>
